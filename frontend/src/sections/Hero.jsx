    ...
    <section id="hero" className="min-h-[85vh] flex flex-col md:flex-row items-center justify-center pt-20">
      <div className="flex-1 space-y-8 flex flex-col items-center md:items-start text-center md:text-left z-10 w-full relative">
        ...
        >
          ...
          <a href="/AYUSH KUMAR.pdf" download className="w-full sm:w-auto px-8 py-4 glass border border-white/10 text-white rounded-lg font-medium hover:bg-white/5 transition flex items-center justify-center gap-2 group hover:border-primary/50">
